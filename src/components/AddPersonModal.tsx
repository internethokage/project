...
interface AddPersonModalProps {
  onClose: () => void;
  onAdd: (person: { name: string; relationship: string; budget: number; notes?: string | null }) => void;
}
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <textarea
                ...
                rows={3}
                placeholder="Interests, hobbies, preferences — helps AI make better suggestions"
              />
            </div>
          </div>
